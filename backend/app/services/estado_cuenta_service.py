...
def generar_estado_cuenta_desde_datos(ruta_plantilla, pagos, contrato_buscado, ruta_salida_excel):
    ...
    MEJORADO: Detecta automáticamente cesiones y las llena en el Excel.
    """
    if not pagos:
        return {"ok": False, "mensaje": f"No se encontró información para: {contrato_buscado}"}
    ...
    try:
        ...
        # Si hay error en cesiones, no dañar el estado de cuenta base
        # Solo registrar el error en logs (opcional)
        pass
